# Brain X · 职位决策工作台 PRD（v2.0，历史产品基线）

> 上级目录：[BrainX 文档书](README.md)
>
> 适用范围：2026-08-24 时点的职位决策工作台定位、功能边界、验收指标与迭代路线。
> 本文保留为历史产品基线，不再裁决 2026-09-02 之后的项目总目标；当前唯一产品 PRD 见
> [BrainX 猎头业务工作流产品 PRD](prd-2026-09-02-brainx-workflow.md)。
