...
> 2026-09-22 补充：本文为 9 月 1 日架构与排期快照，不以当时“未建成”判断当前状态。仓库模块化、Canonical Job 和 Agent 最终推荐的新施工标准见[重构总手册](2026-09-22-refactor-agentic-ranking-manual.md)；权限、Case、确认与事件规范继续有效。
