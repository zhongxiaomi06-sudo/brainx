...
export const actionLabel:Record<EngagementCommand,string>={WATCH:"关注",UNWATCH:"取消关注",ACCEPT:"开始跟进",DISMISS:"暂不考虑",RELEASE:"释放",COMPLETE:"完成"};
export const stateLabel:Record<EngagementState,string>={NEW:"未开始",RECOMMENDED:"已推荐",VIEWED:"已查看",WATCHED:"关注中",ACCEPTED:"跟进中",DISMISSED:"暂不考虑",RELEASED:"已释放",COMPLETED:"已完成",EXPIRED:"已过期"};
